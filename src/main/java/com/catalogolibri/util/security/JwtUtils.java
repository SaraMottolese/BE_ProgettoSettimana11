...
// ti do l'utente autenticato e tu mi devi ridare il token
...
// dal token mi restituisci l'utente 
	public String getUserNameFromJwtToken(String token) {
		return Jwts.parser().setSigningKey(jwtSecret).parseClaimsJws(token).getBody().getSubject();
	}
//ho un authorization token e lo valido. se restituisce true ok altrimenti da errore
